...
public class SingleLinkedListDemo {
    public static void main(String[] args) {
       ...
       SingleLinkedList singleLinkedList = new SingleLinkedList();
        ...
        HeroNode heroNode = mergeList(hero1,hero2);
        System.out.println("合并以后的链表为：");
        while(heroNode!=null){
...
//        reversePrint(singleLinkedList.getHead());
        ...
        /**
         //加入按照编号的顺序
        singleLinkedList.addByteOrder(hero1);
        singleLinkedList.addByteOrder(hero3);
        singleLinkedList.addByteOrder(hero4);
        singleLinkedList.addByteOrder(hero2);
        singleLinkedList.addByteOrder(hero2);
        singleLinkedList.addByteOrder(hero2);
        //显示
        singleLinkedList.list();
  ...
  */
    ...
    //方式2：
    // 可以利用栈这个数据结构，将各个节点压入栈中，利用先进后出的特点，就实现逆序打印
...
class SingleLinkedList{
    ...
    //（如果有这个排名，则添加失败，并给出提出）
    public void addByteOrder(HeroNode heroNode){
        ...
        if (flag){ //不能添加，说明编号存在
            ...
            //插入到链表中，temp的后面
            heroNode.next=temp.next; //后面一条线
            temp.next=heroNode;//前面的线
        }
    }
