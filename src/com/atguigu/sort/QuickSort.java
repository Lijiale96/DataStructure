...
//        System.out.println("arr="+ Arrays.toString(arr));
    ...
    public static void quickSort(int[] arr,int left,int right){
        ...
        while(l<r){
            ...
            //如果l >= r 说明pivot 的左右两边的值，已经按照左边全部是小于等于pivot值，右边全部是大于等于pivot值
            if (l>=r){
                  break;
            }
            //交换
