...
//        List<String> rpnList1 = getListString(suffixExpression1);
     //   System.out.println("rpnList=" + rpnList);
//        System.out.println("rpnList1=" + rpnList1);

       // int res = calculate(rpnList);
//        int res1 = calculate(rpnList1);
...
//        System.out.println("计算的结果是="+res1);
    ...
    public static List<String> parseSuffixExpressionList(List<String> ls){
        ...
        //Stack<String> s2 = new Stack<String>(); //存储中间结果德1栈s2
        ...
        for (String item:ls){
            ...
            s1.pop();//!!!将（弹出 s1栈，消除小括号
                ...
                //当item的优先级小于等于s1栈顶运算符，将s1栈顶的运算符弹出并加入到s2中，再次转到（4.1）与s1中新栈顶运算符相比较
                //问题：我们缺少一个比较优先级高低的方法
    ...
    public  static List<String> getListString(String suffixExpresssion){
        ...
        String[] split = suffixExpresssion.split(" ");
